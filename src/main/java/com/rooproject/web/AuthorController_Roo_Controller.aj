...
import com.rooproject.web.AuthorController;
...
privileged aspect AuthorController_Roo_Controller {
    ...
    void AuthorController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("author_birthdate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
