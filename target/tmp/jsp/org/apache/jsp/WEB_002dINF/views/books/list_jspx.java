...
public final class list_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_page_list_0(PageContext _jspx_page_context)
    ...
    _jspx_th_page_list_0.setZ("FHjFjoRNCpYkQmXiAPbs352ddc4=");
    _jspx_th_page_list_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${books}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_page_list_0.setId("pl_com_rooproject_domain_Book");
  ...
  private boolean _jspx_meth_table_table_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_table_0.setZ("4KYFAPaIo9PbH6+SjIHMQyviTBQ=");
    _jspx_th_table_table_0.setPath("/books");
    _jspx_th_table_table_0.setId("l_com_rooproject_domain_Book");
    _jspx_th_table_table_0.setData((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${books}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_table_column_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_0.setZ("kYMGUH1HzWD5JdKhsomXofsVqiw=");
    _jspx_th_table_column_0.setProperty("bookID");
    _jspx_th_table_column_0.setId("c_com_rooproject_domain_Book_BookID");
  ...
  private boolean _jspx_meth_table_column_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_1.setZ("PYlOgrpfjMBcRYFYKM9G1q4y1Ec=");
    _jspx_th_table_column_1.setProperty("title");
    _jspx_th_table_column_1.setId("c_com_rooproject_domain_Book_title");
  ...
  private boolean _jspx_meth_table_column_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_2.setZ("jcdHtxbDFjbRbnnFbwVsuBqG5yA=");
    _jspx_th_table_column_2.setProperty("author");
    _jspx_th_table_column_2.setId("c_com_rooproject_domain_Book_Author");
  ...
  private boolean _jspx_meth_table_column_3(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_3.setZ("K7t5p3FE37DEpbjq+RHujoggLhg=");
    _jspx_th_table_column_3.setProperty("ISBN");
    _jspx_th_table_column_3.setId("c_com_rooproject_domain_Book_ISBN");
